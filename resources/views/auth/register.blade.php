...
<!--end::Head-->
<!--begin::Body-->
<body id="kt_body" class="bg-dark" style="font-family: 'Mulish', sans-serif !important;">
<!--begin::Main-->
    ...
    <div
            ...
            <div class="w-lg-600px bg-body rounded shadow-sm p-10 p-lg-15 mx-auto">
                ...
                <form class="form w-100" novalidate="novalidate" id="kt_sign_up_form">
                    ...
                    <div class="mb-10 text-center">
                        ...
                        <!--end::Title-->
                        <!--begin::Link-->
                        <div class="text-gray-400 fw-bold fs-4">@lang('auth.already_have_an_account')
                            <a href="{{route('login')}}" class="link-primary fw-bolder">@lang('auth.sign_in_here')</a>
                        </div>
                        <!--end::Link-->
                    </div>
                    <!--end::Heading-->
                    <div class="row fv-row mb-7">
                        <!--begin::Col-->
                        <div class="col-xl-6">
                            <label class="form-label fw-bolder text-dark fs-6">@lang('auth.last_name')</label>
                        ...
                        <!--begin::Col-->
                        <div class="col-xl-6">
                            <label class="form-label fw-bolder text-dark fs-6">@lang('auth.first_name')</label>
                            <input class="form-control form-control-lg form-control-solid" type="text" placeholder=""
                    ...
                    <!--begin::Input group-->
                    <div class="fv-row mb-7">
                        <label class="form-label fw-bolder text-dark fs-6">@lang('auth.phone')</label>
                        <input class="form-control form-control-lg form-control-solid" type="text" placeholder=""
                    ...
                    <div class="mb-10 fv-row" data-kt-password-meter="true">
                        ...
                        <!--end::Wrapper-->
                        <!--begin::Hint-->
                        <div class="text-muted">@lang('auth.password_rule')</div>
                        <!--end::Hint-->
                    </div>
                    <!--end::Input group=-->
                    <!--begin::Input group-->
                    ...
                    <div class="fv-row mb-10">
                        <label class="form-check form-check-custom form-check-solid form-check-inline">
                            ...
                            <span class="form-check-label fw-bold text-gray-700 fs-6">@lang('auth.i_agree')
									<a href="#" class="ms-1 link-primary">@lang('auth.terms_and_conditions')</a>.</span>
                        </label>
                    </div>
                    <!--end::Input group-->
                    <!--begin::Actions-->
                    <div class="text-center">
                        <button type="button" id="kt_sign_up_submit" class="btn btn-lg btn-primary">
                            <span class="indicator-label">@lang('auth.submit')</span>
                            <span class="indicator-progress">@lang('auth.please_wait')
        ...
        <div class="d-flex flex-center flex-column-auto p-10">
            ...
            <div class="d-flex align-items-center fw-bold fs-6">
                <a href="#" class="text-muted text-hover-primary px-2">@lang('auth.about')</a>
                <a href="#" class="text-muted text-hover-primary px-2">@lang('auth.contact')</a>
            </div>
            <!--end::Links-->
        </div>
        <!--end::Footer-->
...
<script>
    const validationMessages = {!! json_encode([
        'first_name_required' => __('auth_validation.first_name_required'),
        ...
        'confirm_not_match' => __('auth_validation.confirm_not_match'),
